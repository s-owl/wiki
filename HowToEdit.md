...
## 기본적인 컨텐츠 수정 방법
위키 컨텐츠를 수정하는 가장 쉬운 방법은, 위키에서 보고 있는 페이지 좌측 상단의 편집 버튼을 클릭하여 편집하는 것 입니다. 그러면 Prose.io 편집 화면에서 바로 편집하여 변경사항을 저장할 수 있습니다.(기존에는 GitHub 내장 편집기 화면이 나왔으나, 편집에 문제가 많아 Prose.io 를 통해 편집하도록 변경되었습니다,.) 웹에서 편집을 하셔도 좋고, 직접 위키 컨텐츠 저장소를 로컬로 복제 하셔서 편집 하실 수도 있습니다. 컨텐츠 저장소를 복제하여 수정하려면, 아래 단계를 따르세요.
